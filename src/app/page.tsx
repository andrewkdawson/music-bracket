...
export default function BracketPage() {
  ...
  return (
    <div className="min-h-screen bg-[#191414] text-white p-6 overflow-x-auto">
      {/* If no artist selected yet → show welcome screen */}
      {!artistId && (
        <div className="max-w-xl mx-auto text-center mt-24">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Build your own bracket with the songs
            from any artist’s discography. <br />
      ...
      {/* If artist selected → show bracket */}
